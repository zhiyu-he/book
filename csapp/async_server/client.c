...
static void handle_events(int epollfd, struct epoll_event *events, int num, int sockfd, char *buf, int len, struct statistics *stat, int echo);

static void do_read(int epollfd, int sockfd, char *buf, int len, struct statistics *stat, int do_echo);

static void do_write(int epollfd, int sockfd, char *buf, int len, struct statistics *stat);
...
static void handle_connection(int sockfd, struct global_args *args, struct statistics *stat) {
    ...
    while (time_flag == 0) {
        ...
        handle_events(epollfd, events, ready_cnt, sockfd, buf, args->len, stat, args->ret);
    }
